...
CREATE TABLE IF NOT EXISTS public.requests (
	...
	CONSTRAINT requests_users_fk FOREIGN KEY (requestor_id) REFERENCES users(id) ON DELETE SET NULL ON UPDATE SET NULL
);
...
CREATE TABLE IF NOT EXISTS public.items (
	...
	CONSTRAINT items_requests_fk FOREIGN KEY (request_id) REFERENCES requests(id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.booking (
	...
	CONSTRAINT booking_users_fk FOREIGN KEY (booker_id) REFERENCES users(id) ON DELETE SET NULL ON UPDATE CASCADE
);
